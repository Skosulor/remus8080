        ...
        *self = Instruction::new();
        ...
        match b & OP_CODE_GROUP_MASK
        {
            ...
            BRANCH_STACK_INSTRUCTION_GROUP => 
            {
                match b 
                {
                    0xC0 => self.name = "RNZ NOT IMP".to_string(),
                    ...
                    0xF8 => self.name = "RM NOT IMP".to_string(),
                    ...
                    0xFC => self.name = "CM NOT IMP".to_string(),
