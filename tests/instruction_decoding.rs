...

{
    ...
    fn decode_add_b()
    {
        ...
        assert_eq!(inst.instruction_type, InstructionTypes::ADD);
        assert_eq!(inst.low_nibble.unwrap(), B_REG);
    }
    ...
    fn decode_add_c()
    {
        ...
        assert_eq!(inst.instruction_type, InstructionTypes::ADD);
        assert_eq!(inst.low_nibble.unwrap(), C_REG);
    }
    ...
    fn decode_add_d()
    {
        ...
        assert_eq!(inst.instruction_type, InstructionTypes::ADD);
        assert_eq!(inst.low_nibble.unwrap(), D_REG);
    }
    ...
    fn decode_add_e()
    {
        ...
        assert_eq!(inst.instruction_type, InstructionTypes::ADD);
        assert_eq!(inst.low_nibble.unwrap(), E_REG);
    }
    ...
    fn decode_add_h()
    {
        ...
        assert_eq!(inst.instruction_type, InstructionTypes::ADD);
        assert_eq!(inst.low_nibble.unwrap(), H_REG);
    }
    ...
    fn decode_add_l()
    {
        ...
        assert_eq!(inst.instruction_type, InstructionTypes::ADD);
        assert_eq!(inst.low_nibble.unwrap(), L_REG);
    }
    ...
    fn decode_add_m()
    {
        ...
        assert_eq!(inst.instruction_type, InstructionTypes::ADD);
        assert_eq!(inst.low_nibble.unwrap(), MEM_REF);
    }
    ...
    fn decode_adc_a()
    {
        ...
        assert_eq!(inst.instruction_type, InstructionTypes::ADD);
        assert_eq!(inst.low_nibble.unwrap(), A_REG);
    }
    ...
    fn decode_adc_b()
    {
        ...
        assert_eq!(inst.instruction_type, InstructionTypes::ADC);
        assert_eq!(inst.low_nibble.unwrap(), B_REG);
    }
    ...
    fn decode_sub_b()
    {
        ...
        assert_eq!(inst.instruction_type, InstructionTypes::SUB);
        assert_eq!(inst.low_nibble.unwrap(), B_REG);
    }
    ...
    fn decode_sbb_b()
    {
        ...
        assert_eq!(inst.instruction_type, InstructionTypes::SBB);
        assert_eq!(inst.low_nibble.unwrap(), B_REG);
    }
    ...
    fn decode_ana_b()
    {
        ...
        assert_eq!(inst.instruction_type, InstructionTypes::ANA);
        assert_eq!(inst.low_nibble.unwrap(), B_REG);
    }
    ...
    fn decode_xra_b()
    {
        ...
        assert_eq!(inst.instruction_type, InstructionTypes::XRA);
        assert_eq!(inst.low_nibble.unwrap(), B_REG);
    }
    ...
    fn decode_ora_b()
    {
        ...
        assert_eq!(inst.instruction_type, InstructionTypes::ORA);
        assert_eq!(inst.low_nibble.unwrap(), B_REG);
    }
    ...
    fn decode_cmp_b()
    {
        ...
        assert_eq!(inst.instruction_type, InstructionTypes::CMP);
        assert_eq!(inst.low_nibble.unwrap(), B_REG);
    }
